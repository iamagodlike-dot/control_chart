...
const PATHS = {
  ...
  // Трубка — экран приёмщика: позвонить клиенту и договориться о дефектовке.
  phone: <path d="M15.6 13.3l-1.5 1.5a12 12 0 0 1-4.9-4.9l1.5-1.5a1 1 0 0 0 .2-1.1L9.5 4.6A1 1 0 0 0 8.6 4H5a1 1 0 0 0-1 1.1A16 16 0 0 0 18.9 20a1 1 0 0 0 1.1-1v-3.6a1 1 0 0 0-.6-.9l-2.7-1.4a1 1 0 0 0-1.1.2Z" />,
  // Конверт — письма из карточки машины («На просчёт»).

...
export const ROLES = {
  ...
  // экран — «Дефектовка» (кого пригласить, кто когда приедет, напоминания). Доска
  // согласования и График нужны ему не для правок, а чтобы честно отвечать клиенту
  // «что дальше» и «когда встанет в работу»; денежные экраны роли не положены.
  receptionist: {
    label: 'Мастер-приёмщик',
    hint: 'Приглашение машин на дефектовку, календарь заездов, напоминания',
